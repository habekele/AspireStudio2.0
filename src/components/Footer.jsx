      ...
      <div className="max-w-site mx-auto px-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-6">
          <div className="flex flex-col gap-1">
            ...
            <span className="font-sans text-[0.54rem] font-semibold tracking-[0.22em] uppercase text-white/28">
        ...
        <div className="mt-6 pt-6 border-t border-white/5 text-center font-sans text-[0.7rem] text-white/18 tracking-wide">
